...
namespace TexDrawLib
{
    ...
    public class DrawingParams
    {
        ...
        void HandlePerLineWrapping(int i)
        {
        ...
        void HandlePerLineWrappingReversed(int i)
        {
            TexRenderer row = m_formulas[i], newrow;
            HorizontalBox box = (HorizontalBox)row.Box;
            List<Box> ch = box.children;
        ...
        Vector2 VecScale(Vector2 a, Vector2 b) { return new Vector2(a.x * b.x, a.y * b.y); }

        Vector2 VecNormal(Vector2 a) { return new Vector2(-a.x + 0.5f, -a.y + 0.5f); }
        ...
        void RenderUV3Line(FillHelper verts, Rect uv, int idx)
        {
