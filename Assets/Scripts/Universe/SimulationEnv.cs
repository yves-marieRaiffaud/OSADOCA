...
public class SimulationEnv : ScriptableObject
{
    ...
    //---------------------------------------------
    [NonSerialized]
    public StopWatch missionTimer; // Timer displayed in the simulation UI
    //---------------------------------------------
    //---------------------------------------------
    //---------------------------------------------
    //---------------------------------------------
    ...
    /// <summary>
    /// Function called to save the specified SimulationEnv 'data' to disk by writing the simEnv JSON file that will be read when intializaing the Universe at simulation's runtime
    /// </summary>
    ...
    /// <summary>
    /// Reading and parsing the JSON simulationEnv file saved on the disk, and returning its corresponding SimulationEnv class
    /// </summary>
