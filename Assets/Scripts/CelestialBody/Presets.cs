...
{
    public static int quadRes = 16; // The resolution of the quads
    public static Vector3[][] quadTemplateVertices = new Vector3[quadRes][];
    public static Vector3[][] quadTemplateBorderVertices = new Vector3[quadRes][];
    public static int[][] quadTemplateTriangles = new int[quadRes][];
    public static int[][] quadTemplateBorderTriangles = new int[quadRes][];
    public static int[][] quadTemplateEdgeIndices = new int[quadRes][]; // Keeps track of which indices are on the edge fans
