...
using Mathd_Lib;
using System;
using PlanetsDict = CelestialBodiesConstants;
...
public class ReferenceFramesList : MonoBehaviour
{
    ...
    void Init_TransformationMatrices()
    {
        ...
        float alpha = (float)PlanetsDict.planetsDict[PlanetsDict.planets.Earth][CelestialBodyParamsBase.planetaryParams.axialTilt.ToString()].val;
