...
public static class LaunchPadList
{
    ...
    //======================================================================================================================
    //======================================================================================================================
    public static Dictionary<UniCsts.planets, Dictionary<string, Dictionary<LaunchPad.launchPadParams, string>>> launchPadsDict = new Dictionary<UniCsts.planets, Dictionary<string, Dictionary<LaunchPad.launchPadParams, string>>>() {
        { UniCsts.planets.Mercury, mercury_launchPads },
        { UniCsts.planets.Venus, venus_launchPads },
        { UniCsts.planets.Earth, earth_launchPads },
        { UniCsts.planets.Mars, mars_launchPads }
    };
