...
public class LaunchPad
{
    ...
    public LaunchPad(Dictionary<launchPadParams, string> ref_launchPadParamsDict)
    {
        ...
        InitVariables();
        MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.latitude], out _latitude);
        MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.longitude], out _longitude);
    ...
    public void RebuildDict()
    {
        ...
        launchPadParamsDict[launchPadParams.latitude] = MathOps.DoubleToString(_latitude);
        launchPadParamsDict[launchPadParams.longitude] = MathOps.DoubleToString(_longitude);
        ...
        launchPadParamsDict[launchPadParams.eastwardBoost] = MathOps.DoubleToString(_eastwardBoost);
    }
    ...
    public void InitVariables()
    {
        ...
        bool parseOk = MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.latitude], out lat);
        if(parseOk)
            _latitude = lat;
        else
        ...
        bool parseOkLong = MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.longitude], out longi);
        if(parseOkLong)
            _longitude = longi;
        else
    ...
    public double ComputeEastwardBoost()
    {
        ...
        double equaRadius = CelestialBodiesConstants.planetsDict[ObjHand.Str_2_Planet(planetName)][CelestialBodyParamsBase.planetaryParams.radius.ToString()].val;
        double polarRadius = CelestialBodiesConstants.planetsDict[ObjHand.Str_2_Planet(planetName)][CelestialBodyParamsBase.planetaryParams.polarRadius.ToString()].val;
    ...
    public Vector2 LatitudeLongitude_2_XY(Vector2 xy_mapSize)
    {
        ...
        bool latSuccess = MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.latitude], out lat);
        bool longSuccess = MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.longitude], out longitude);
        //=========
    ...
    public Vector2 Get_Lat_Long()
    {
        ...
        MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.latitude], out latitude);
        MathOps.ParseStringToDouble(launchPadParamsDict[launchPadParams.longitude], out longitude);
        return new Vector2((float)latitude, (float)longitude);
    }

    public static (LaunchPad,bool) GetLaunchPadFromName(string launchPadName, CelestialBodiesConstants.planets planetOfTheLaunchPad, bool alsoSearchInCustomLaunchPads)
    {
    ...
    public static LaunchPad[] GetEveryLaunchPadsOfPlanet(CelestialBodiesConstants.planets planetOfTheLaunchPad, bool includeCustomLaunchPads)
    {
    ...
    public static string[] GetEveryLaunchPadsNamesOfPlanet(CelestialBodiesConstants.planets planetOfTheLaunchPad, bool includeCustomLaunchPads)
    {
        // Returns an array of launchPads included in the specified planet
        //==================================
